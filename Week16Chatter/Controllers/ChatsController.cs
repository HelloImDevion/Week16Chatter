...
using Week16Chatter.Models;
using Newtonsoft.Json;

namespace Week16Chatter.Controllers
{
    public class ChatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ChatID,UserID,Message,Datetime")] Chat chat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ChatID,UserID,Message,Datetime")] Chat chat)
        {
            if (ModelState.IsValid)
            {
